...
"""jersi_build_app.py builds a one-file executable for Windows OS."""
...
print()
print("Building jersi_certu application ...")
os.chdir(os.path.join(_product_home, "jersi_certu"))
...
if os.path.isfile("jersi_certu.spec"):
   os.remove("jersi_certu.spec") 
...
print()
print("Building jersi_certu application done")
